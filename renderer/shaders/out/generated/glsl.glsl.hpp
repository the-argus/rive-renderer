...
#endif
#define ca(c,a) Q2(c,a)
#ifdef EB
#define J3(d2,a) layout(binding=d2,set=B7)uniform mediump sampler a;
#define l3(d2,a) layout(binding=d2,set=B7)uniform mediump sampler a;
...
#define R2(c,d1,a) ca(c,a)
#define N3(c,d1,a) i4(c,a)
#define z0(a,A0) I1(a,m0((A0)&m7,(A0)>>l7))
#define q2(a,A0) I1(a,m0((A0)&m7,(A0)>>l7)).xy
#else
...
#define r2(j4,a) layout(location=0)out j4 da;void main()
#define v2(l) da=l
