...
#ifdef CLEAR_COLOR
#if __VERSION__>=310
layout(binding=0,std140)uniform eb{uniform highp vec4 sa;}ta;
#else
...
#ifdef LOAD_COLOR
layout(location=0)inout mediump vec4 m6;
#endif
#endif
#ifdef STORE_COLOR
layout(location=0)out mediump vec4 m6;
#endif
void main(){
#ifdef CLEAR_COLOR
#if __VERSION__>=310
...
#else
layout(location=0)out mediump vec4 ua;void main(){ua=vec4(0,1,0,1);}
#endif
#endif
